...
\setcounter{chapter}{4} % Thiết lập chương tiếp theo sẽ là Chương 5
...
Trả lời thắc mắc về chính sách giao hàng, tải trọng tối đa của drone, và khu vực hỗ trợ.
Truy vấn trạng thái chuyến bay của drone dựa trên Mã đơn hàng (Order ID).
...
\textbf{AI-Services Container:} Chạy ứng dụng FastAPI chứa mô hình ETA, Chatbot và Summarization.

\textbf{Backend Container:} Xử lý logic nghiệp vụ và quản lý đội bay Drone.

\textbf{Database Container:} Cơ sở dữ liệu PostgreSQL / MongoDB lưu trữ hành trình.
