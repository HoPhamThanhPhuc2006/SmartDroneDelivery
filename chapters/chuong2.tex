...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{images/chuong2/usecase.png}
    \caption{Sơ đồ Use Case của hệ thống SmartDroneDelivery}
    \label{fig:usecase}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/chuong2/bpmn.png}
    \caption{Mô hình hóa quy trình nghiệp vụ giao hàng bằng drone}
    \label{fig:bpmn}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images/chuong4/design-system.png.png}
    \caption{Thiết kế hệ thống giao diện SmartDroneDelivery}
    \label{fig:design-system}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images/chuong4/mobile-screens.png.png}
    \caption{Thiết kế giao diện trên thiết bị di động}
    \label{fig:mobile-ui}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images/chuong4/web-portal-dashboard.png.jpg}
    \caption{Giao diện dashboard quản lý trên nền web}
